    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יסכה עיסוי רפואי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7e9106c9-29a3-4a1b-a0e8-5eb44dac7568',
                    name: data.name || '',
                    email: data.email || '',
